...
for N_ks in N_ks_vec
    ...
    save(example_path * "$(N_ks...)_$(N_1d)/benchmark.jld2", "t_isdf", t_isdf, "t_H_setup", t_H_setup, "t_H_x", t_H_x)
end

# %% save results

results = [load("diamond/$(N_ks...)_$(N_1d)/benchmark.jld2") for N_ks in N_ks_vec]
...
save(example_path * "/benchmark.jld2", "N_ks_vec", N_ks_vec, "setup_times", setup_times, "evaluation_times", evaluation_times)
